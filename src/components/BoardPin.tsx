      ...
      >
        <defs>
          <radialGradient id={`board-cone-grad-${board.id}`} cx="0%" cy="0%" r="100%">
            <stop offset="0%" stopColor={BOARD_CONE_COLOR} stopOpacity={selected ? 0.25 : 0.15} />
            <stop offset="100%" stopColor={BOARD_CONE_COLOR} stopOpacity={0.03} />
          </radialGradient>
        </defs>
        <polygon
